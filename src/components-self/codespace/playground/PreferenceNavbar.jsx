...
const PreferenceNav = () => {
  return (
    <div className="flex flex-col bg-gradient-to-b from-violet-200 from-10% to-purple-100 dark:bg-gradient-to-b dark:from-slate-800 from-5% dark:to-purple-800 transition-colors duration-200">
